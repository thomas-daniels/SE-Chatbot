...
commands = [
    Command('random', command_random, "", False, False),
    Command('randomint', command_randomint, "", False, False),
    Command('randomchoice', command_randomchoice, False, False),
    Command('shuffle', command_shuffle, "", False, False)
]
